...
describe("Product Tests", () => {
  ...
  test("Correctly sets values of name, price, description, and inStock", () => {
    ...
    expect(carrots.description).toEqual(
      "Bushel of carrots that have been freshly harvested for you"
    );
  ...
  test("display method returns correct string", () => {
    ...
    expect(carrots.display()).toEqual(
      "Name: Carrots, Price: $4, Description: Bushel of carrots that have been freshly harvested for you"
    );
  });
});
...
describe("Stretch Tests", () => {
  test("Can get total and clear", () => {
    ...
    expect(myCart.products.length).toEqual(2);
    expect(myCart.total).toEqual(8);
    expect(myCart.getTotal()).toEqual(8);
    myCart.clear();
    expect(myCart.products.length).toEqual(0);
    expect(myCart.getTotal()).toEqual(0);
  });

  test("Can get rewardPoints", () => {
    const francis = new Customer("Francis", "francis@gmail.com", "222 Main St");
    const strawberries = new Product(
      "Strawberries",
      5,
    ...
    const mangos = new Product(
      "Mangos",
      3,
      "The tastiest fruit you can buy",
      1
    );
    ...
    francis.addToOrderHistory(mySecondOrder);
    expect(francis.orderHistory.length).toEqual(2);
    francis.getRewardPoints();
    expect(francis.rewardPoints).toEqual(10);
  });

   test("Can remove item by name", () => {
     const strawberries = new Product(
       "Strawberries",
       5,
       "The freshest fresas on the market"
